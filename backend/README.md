...
## Project Structure
    ...
    ├── testapiautodatamod_124905  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_124905`
...
2. Clone this repo and `cd testapiautodatamod_124905`
